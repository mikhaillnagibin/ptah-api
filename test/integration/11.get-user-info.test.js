...
describe(`GET ${routesPrefix}`, () => {
    ...
    it("should return valid response for authenticated user", (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.body._id.should.be.eql(fakes.fakeUserId);
    ...
    it("should return valid response for authenticated another user", (done) => {
        chai.request(server)
            .get(`${routesPrefix}`)
            ...
            .end((err, res) => {
                should.not.exist(err);
                res.status.should.eql(200);
                res.body._id.should.be.eql(fakes.fakeAnotherUserId);
